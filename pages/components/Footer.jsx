  ...
  return (
    <footer className='w-full'>
      ...
      <div className='flex justify-around w-[70%] mx-auto my-10 text-[33px]'>
        ...
        <Link target='_blank' href='https://twitter.com/VEijjttgIUUGH6k'><RiTwitterXFill /></Link>
        <Link target='_blank' href='https://github.com/takuyanagamachi/next-kenma' className=''><AiFillGithub /></Link>
      </div>
      <div>
        <p className='text-center'>&copy;1955 -{new Date().getFullYear()}  株式会社 <Link target='_blank' href='/find'>長町研磨</Link></p>
      </div>
