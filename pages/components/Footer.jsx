...
export default function Header() {
  return (
    <footer className='w-full'>
      ...
      <Link href='/'><Image src={Logo} width={60}  className='mx-auto' /></Link>
      ...
      <div className='flex justify-around w-[70%] mx-auto my-10 text-[33px]'>
          <a href="/" className={styles.insta}><AiOutlineInstagram /></a>
          <a href="/" className={styles.twitter}><AiOutlineTwitter className='' /></a>
          <a href="/" className=''><AiFillGithub /></a>
        </div>
     <div className=''>
